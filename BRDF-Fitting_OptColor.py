...
file_path = 'measured_BRDF/' + file_name + '.astm'  #データパスの指定
sample_data = read_sample(file_path)
#print(data[0][4])

measure_rgb = [0.1680799752154287, 0.013749170393403287, 0.012336460333516739]
...
def optimize(targetBRDF, measures, scene_params, steps, keys, lr = 0.001):
    ...
    #jsonfileに書き込み
    with open('Results_json/' + file_name + ".json", 'w') as json_file:
